...
If($StatusID >=3 ){
    ...
    //echo "<script type='text/javascript'>Bạn không thể sửa ticket này</script>";
}
else
{
    ...
    //updating the table
    $result = mysqli_query($mysqli, "UPDATE `ticket` SET `Subject`='$subject',`Content`='$content' WHERE ID=$id");        
    $sqlLogs = mysqli_query($mysqli,"INSERT INTO tickethistory (TicketID,Activity,UserID) VALUES ('$id','Sửa ticket','$studentid')");
                                ...
                                <div class="panel-body">
                                    <form action="editticket.php" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="5" id="" type="text" name="content"><?php echo $content;?></textarea>
                                        ...
                                        <div class="form-actions">
                                            <button  type="button" class="btn btn-default" onclick="location.href='listticket.php'">Cancel</button>
                                            <!-- <button type="submit" class="btn btn-default" name="Draft" value="Cancel">Hủy</button> -->
