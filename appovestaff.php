...
{    
    ...
    //updating the table
    $result = mysqli_query($mysqli, "UPDATE `ticket` SET `StatusID`= 5 WHERE ID=$id");        
    $sqlLogs = mysqli_query($mysqli,"INSERT INTO tickethistory (TicketID,Activity,UserID) VALUES ('$id','Đã tiếp nhận xử lý','$leaderid')");
    //redirectig to the display ppassword. In our case, it is index.php
        header("Location: listticketstaff.php");
...
$result = mysqli_query($mysqli, "SELECT * FROM ticket WHERE ID=$id");
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="index.html"><b><img src="plugins/images/eliteadmin-logo.png" alt="home" /></b><span class="hidden-xs"><strong>elite</strong>realestate</span></a></div>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="property-4-column.html" class="waves-effect"><i class="ti-layout fa-fw"></i> <span class="hide-menu">Yêu cầu chờ xác nhận</span></a> </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            <div class="panel-heading">Đơn xin học lại</div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="appovestaff.php" method="post"> 
                                        <div class="form-body">                                      
                                            <div class="row">
                                                <div class="col-md-12 ">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="5" id="" type="text" name="content" readonly><?php echo $content;?></textarea>
                                        ...
                                        <div class="form-actions">
                                            <button type="button" class="btn btn-default" onclick="location.href='listticketstaff.php'">Cancel</button>
                                            <button type="submit" class="btn btn-success" name="update" value="Update">Phê duyệt</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
