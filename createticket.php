...
if(isset($_POST['Submit'])){
    ...
    $result = mysqli_query($mysqli,"INSERT INTO ticket(StudentID, StatusID, CatID, Subject, Content) Values('$studentid', 2,1, '$title', '$content')");
   
    if($result)
    {
        $lastestID = mysqli_insert_id($mysqli);
        //echo"thêm thành công ticket";
        //Thực hiện gửi mail
        try {
            //Server settings
            $mail->CharSet = "UTF-8";
            ...
            $mail->Subject = 'Ticket số #'.$lastestID. ' vừa được tạo' ;
                    ...
                    <tbody>
                      <tr>
                        <td><b>Dear Sir/Madam/Customer,</b>
                          <p>Ticket số #'.$lastestID.' vừa được tạo, vui lòng click nút bên dưới để phê duyệt</p>
        ...
        //Thực hiện insert dữ liệu vào bảng ticket history
        $sqlLogs = mysqli_query($mysqli,"INSERT INTO tickethistory (TicketID,Activity,UserID) VALUES ('$lastestID','Tạo ticket','$studentid')");
...
if(isset($_POST['Draft'])){
    ...
    $content = $_POST['content'];
    $studentid = $_SESSION['id'];
    $result = mysqli_query($mysqli,"INSERT INTO ticket(StudentID, StatusID, CatID, Subject, Content) Values('$studentid', 1,1, '$title', '$content')");
    if($result)
    {
        $lastestID = mysqli_insert_id($mysqli);
        //echo"lưu nháp thành công";
        //Lưu logs
        $sqlLogs = mysqli_query($mysqli,"INSERT INTO tickethistory (TicketID,Activity,UserID) VALUES ('$lastestID','Lưu nháp ticket','$studentid')");
        header("Location: listticket.php");
    }
    else
    {
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="index.php"><b><img src="plugins/images/Logo-FPT.png" alt="home" style="margin-left: 35px;"></b><span class="hidden-xs"></a></div>
                                ...
                                <div class="panel-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="submit" class="btn btn-default" name="Draft" value="Add">Lưu nháp</button>
                                            <button type="submit" class="btn btn-success" name="Submit" value="Add">Gửi</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
