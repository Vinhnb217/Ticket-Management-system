...
if(isset($_SESSION['valid'])) {                             
        $result = mysqli_query($mysqli, "SELECT * FROM ticketcategories JOIN ticket on ticketcategories.ID = ticket.CatID JOIN user on ticket.StudentID = user.UserID JOIN Status on ticket.StatusID = Status.StatusID  where ticketcategories.DeptID = $deptID AND ticket.StatusID = 7 ORDER BY ticket.ID DESC");
?>
    <!-- Preloader -->
    <div class="preloader">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    while($res = mysqli_fetch_array($result)) {         
                                        ...
                                        echo "<td>".$res['Name']."</td>";
                                        echo "<td><a href=\"confirm.php?id=$res[ID]\">Confirm</a> | <a href=\"reopen.php?id=$res[ID]\">Reject</a></td>";        
                                    }
                                    ?>
