...
{    
    ...
    //updating the table
    $result = mysqli_query($mysqli, "UPDATE `ticket` SET `StatusID`= 4,  `Reason`= '$reason' WHERE ID=$id");        
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="rejectleader.php" method="post">
                                        <div class="form-body">                                      
                                            <div class="row">
                                                <div class="col-md-12 ">
                                        ...
                                        <button  type="button" class="btn btn-default" onclick="location.href='listticketstaff.php'">Cancel</button>
                                            <!-- <button type="submit" class="btn btn-default" name="Draft" value="Add">Hủy</button> -->
