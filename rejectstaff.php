...
{    
    ...
    $reason=$_POST['reason'];
    //updating the table
    $result = mysqli_query($mysqli, "UPDATE `ticket` SET `StatusID`= 6 WHERE ID=$id");        
    $sqlLogs = mysqli_query($mysqli,"INSERT INTO tickethistory (TicketID,Activity,UserID) VALUES ('$id','Từ chối tiếp nhận','$leaderid')");
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="rejectstaff.php" method="post">
                                        <div class="form-body">                                      
                                            <div class="row">
                                                <div class="col-md-12 ">
                                        ...
                                        <button  type="button" class="btn btn-default" onclick="location.href='listticketstaff.php'">Cancel</button>
                                            <button type="submit" class="btn btn-success" name="update" value="Update">Từ chối</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
