...
if(isset($_POST['search'])){
    ...
    {
        $result = mysqli_query($mysqli,"SELECT * from ticketcategories JOIN ticket on ticket.CatID = ticketcategories.ID JOIN Status on ticket.StatusID=Status.StatusID JOIN user on ticket.StudentID = user.UserID where ticketcategories.DeptID = $deptID AND ticket.StaffID=$studentid ORDER BY ticket.ID DESC");
    }
    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li> <a href="listwip.php" class="waves-effect"><i class="ti-menu-alt fa-fw"></i> <span class="hide-menu">Yêu cầu đang xử lý</span></a> </li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">List ticket for staff</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form role="form" class="row" action="listticketstaff.php" method="post">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    while($res = mysqli_fetch_array($result)) {         
                                        ...
                                        echo "<td><a href=\"appovestaff.php?id=$res[ID]\">Approve</a> | <a href=\"rejectstaff.php?id=$res[ID]\">Reject</a></td>";        
                                    }
                                    ?>
