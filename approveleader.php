...
{    
    ...
    //updating the table
    $result = mysqli_query($mysqli, "UPDATE `ticket` SET `StatusID`= 3, `StaffID`='$StaffID' WHERE ID=$id");        
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="approveleader.php" method="post">
                                        <div class="form-body">                                      
                                            <div class="row">
                                                <div class="col-md-12 ">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="StaffID">
                                                            <?php
                                                            $sql = mysqli_query($mysqli,"SELECT * from user where DeptID=3");
                                        ...
                                        <div class="form-actions">
											<button  type="button" class="btn btn-default" onclick="location.href='listticketleader.php'">Cancel</button>
