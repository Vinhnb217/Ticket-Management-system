...
{    
    ...
    //updating the table
    $result = mysqli_query($mysqli, "UPDATE `ticket` SET `StatusID`= 7 WHERE ID=$id");        
    $sqlLogs = mysqli_query($mysqli,"INSERT INTO tickethistory (TicketID,Activity,UserID) VALUES ('$id','Đang xử lý','$staffid')");
