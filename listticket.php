...
if(isset($_POST['search'])){
    ...
    if ($valueToSearch <>""){
        $result = mysqli_query($mysqli,"SELECT * from ticket JOIN user on ticket.studentid = user.userid JOIN status on ticket.statusid = status.statusid where ticket.studentid = $studentid AND ticket.Subject LIKE '%$valueToSearch%' OR ticket.ID='$valueToSearch'");
    }
    else
    {
        $result = mysqli_query($mysqli,"SELECT * from ticket JOIN user on ticket.studentid = user.userid JOIN status on ticket.statusid = status.statusid where ticket.studentid = $studentid ORDER BY ticket.ID DESC");
    }
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Ticket Management System</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form role="form" class="row" action="listticket.php" method="post">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    while($res = mysqli_fetch_array($result)) {         
                                        ...
                                        echo "<td><a href=\"editticket.php?id=$res[ID]\">Edit</a> | <a href=\"del.php?id=$res[ID]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";        
                                    }
                                    ?>
