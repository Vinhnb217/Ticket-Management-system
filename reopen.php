...
{    
    ...
    //updating the table
    $result = mysqli_query($mysqli, "UPDATE `ticket` SET `StatusID`= 9 WHERE ID=$id");        
    $sqlLogs = mysqli_query($mysqli,"INSERT INTO tickethistory (TicketID,Activity,UserID) VALUES ('$id','Từ chối xử lý','$leaderid')");
    //redirectig to the display ppassword. In our case, it is index.php
        header("Location: listticketleader.php");
                                ...
                                <div class="panel-body">
                                    <form action="reopen.php" method="post"> 
                                        ...
                                        <div class="form-actions">
                                            <button type="button" class="btn btn-default" onclick="location.href='listwip.php'">Cancel</button>
